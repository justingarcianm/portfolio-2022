...
const PostHeader = ({ title, time, authorName, authorImage, categories, postImage }) => {
   
   return <PostHeading image={postImage} >
        <div>
            <CategoryContainer>
                <p>Categories:</p>
            ...
            <AuthorMeta>
                ...
                <div>
                    ...
                    <h5>Published: <Moment date={time} format="MMM DD, YYYY"/></h5>
                </div>
            </AuthorMeta>
        </div>
    </PostHeading>
